...
4: edit BrowseTheWeb.xmp2 new version, description etc
5: release build again, and Change url of OnlineLocation of old files in BrowseTheWeb.xml
6: Edit http://www.team-mediaportal.com/extensions/news-info/browse-the-web-webbrowser
   - Update version
   - Update changelog
   - Upload new MPE1
7: Notify on forum
